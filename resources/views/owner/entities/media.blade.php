    ...
    <div class="mx-auto max-w-5xl space-y-6 bg-white">
        ...
        <div class="space-y-6 rounded-lg border border-gray-300 p-4">
            <div class="space-y-2">
                ...
                <form method="POST" action="{{ route('owner.entities.media.images.store', $entity) }}" enctype="multipart/form-data" class="space-y-2">
                    @csrf
            ...
            <div class="space-y-2">
                ...
                <form method="POST" action="{{ route('owner.entities.media.video.store', $entity) }}" class="flex flex-wrap items-end gap-2">
                    @csrf
