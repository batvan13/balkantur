...
@section('title', 'Добавяне на обект')
...
@section('content')
    <div class="mx-auto max-w-5xl space-y-6 bg-white">
        ...
        <form method="POST" action="{{ route('owner.entities.store') }}" class="space-y-4 rounded-lg border border-gray-300 p-4">
            @csrf
